...
recipes.addShaped("peel", <pizzacraft:peel>, [
...
recipes.addShaped("white_cloth", <pizzacraft:white_cloth> * 3, [
...
recipes.addShapeless("red_cloth", <pizzacraft:red_cloth>, [<pizzacraft:white_cloth>, <minecraft:dye:1>]);


recipes.remove(<pizzacraft:pizza_bag>);
recipes.addShaped("pizza_bag", <pizzacraft:pizza_bag>, [

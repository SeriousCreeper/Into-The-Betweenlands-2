...
recipes.addShapeless("lime_water_wood", <thebetweenlands:bl_bucket:0>.withTag({Fluid: {FluidName: "lime_water", Amount: 1000}}), [
...
recipes.addShapeless("lime_water_syrmorite", <thebetweenlands:bl_bucket:1>.withTag({Fluid: {FluidName: "lime_water", Amount: 1000}}), [

...
recipes.addShaped("axle_wood", <rustichromia:axle_wood>, [
    [<ore:plankWood>],
    [<ore:stickWood>],
    [<ore:plankWood>]
]);
...
recipes.addShaped("windmill_big", <rustichromia:windmill_big>, [

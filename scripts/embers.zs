...
recipes.addShapeless("embers-blend_caminite", <embers:blend_caminite> * 8, [<thebetweenlands:sap_spit>, <thebetweenlands:sap_spit>, <thebetweenlands:sap_spit>, <thebetweenlands:silt>]);
...
recipes.addShaped("embers-stamp_base", <embers:stamper_base>, [
	...
	[<embers:block_caminite_brick:*>, <thebetweenlands:bl_bucket:1>, <embers:block_caminite_brick:*>]]);
...
Melter.add(<liquid:syrmorite> * 288, <thebetweenlands:syrmorite_ore>);
Melter.add(<liquid:syrmorite> * 144, <thebetweenlands:items_misc:11>);
Melter.add(<liquid:syrmorite> * 144, <embers:plate_iron>);
Melter.add(<liquid:syrmorite> * 16, <thebetweenlands:items_misc:41>);

Melter.remove(<liquid:gold>);
Melter.add(<liquid:octine> * 288, <thebetweenlands:octine_ore>);
Melter.add(<liquid:octine> * 144, <thebetweenlands:octine_ingot>);
Melter.add(<liquid:octine> * 144, <embers:plate_gold>);
Melter.add(<liquid:octine> * 16, <thebetweenlands:items_misc:42>);
...
<thebetweenlands:items_misc:45>.addTooltip(format.green("Can be used as Embers fuel"));
